...
#define BAOBAB_TREEMAP(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), BAOBAB_TREEMAP_TYPE, BaobabTreemap))
#define BAOBAB_TREEMAP_CLASS(obj) \
  (G_TYPE_CHECK_CLASS_CAST((obj), BAOBAB_TREEMAP, BaobabTreemapClass))
#define BAOBAB_IS_TREEMAP(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), BAOBAB_TREEMAP_TYPE))
#define BAOBAB_IS_TREEMAP_CLASS(obj) \
  (G_TYPE_CHECK_CLASS_TYPE((obj), BAOBAB_TREEMAP_TYPE))
#define BAOBAB_TREEMAP_GET_CLASS \
  (G_TYPE_INSTANCE_GET_CLASS((obj), BAOBAB_TREEMAP_TYPE, BaobabTreemapClass))
