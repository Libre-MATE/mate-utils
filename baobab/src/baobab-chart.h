...
#define BAOBAB_CHART(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), BAOBAB_CHART_TYPE, BaobabChart))
#define BAOBAB_CHART_CLASS(obj) \
  (G_TYPE_CHECK_CLASS_CAST((obj), BAOBAB_CHART_TYPE, BaobabChartClass))
#define BAOBAB_IS_CHART(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), BAOBAB_CHART_TYPE))
#define BAOBAB_IS_CHART_CLASS(obj) \
  (G_TYPE_CHECK_CLASS_TYPE((obj), BAOBAB_CHART_TYPE))
#define BAOBAB_CHART_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), BAOBAB_CHART_TYPE, BaobabChartClass))
...
struct _BaobabChartClass {
  ...
  /* Signal prototypes */
  void (*item_activated)(BaobabChart *chart, GtkTreeIter *iter);

  /* Abstract methods */
  void (*draw_item)(GtkWidget *chart, cairo_t *cr, BaobabChartItem *item,
                    gboolean highlighted);

  void (*pre_draw)(GtkWidget *chart, cairo_t *cr);

  void (*post_draw)(GtkWidget *chart, cairo_t *cr);

  void (*calculate_item_geometry)(GtkWidget *chart, BaobabChartItem *item);

  gboolean (*is_point_over_item)(GtkWidget *chart, BaobabChartItem *item,
                                 gdouble x, gdouble y);

  void (*get_item_rectangle)(GtkWidget *chart, BaobabChartItem *item);
...
void baobab_chart_set_model_with_columns(GtkWidget *chart, GtkTreeModel *model,
                                         ...
                                         guint valid_column, GtkTreePath *root);
...
void baobab_chart_get_item_color(BaobabChartColor *color, gdouble position,
