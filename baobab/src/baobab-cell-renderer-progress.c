...
enum { PROP_0, PROP_PERC };

struct _BaobabCellRendererProgressPrivate {
  double perc;
};

G_DEFINE_TYPE_WITH_PRIVATE(BaobabCellRendererProgress,
                           baobab_cell_renderer_progress,
                           GTK_TYPE_CELL_RENDERER)

static void baobab_cell_renderer_progress_init(
    BaobabCellRendererProgress *cellprogress) {
  cellprogress->priv =
      baobab_cell_renderer_progress_get_instance_private(cellprogress);
...
static void baobab_cell_renderer_progress_get_property(GObject *object,
                                                       guint param_id,
                                                       GValue *value,
                                                       GParamSpec *pspec) {
  BaobabCellRendererProgress *cellprogress =
      BAOBAB_CELL_RENDERER_PROGRESS(object);
...
static void baobab_cell_renderer_progress_set_property(GObject *object,
                                                       guint param_id,
                                                       const GValue *value,
                                                       GParamSpec *pspec) {
  BaobabCellRendererProgress *cellprogress =
...
static void baobab_cell_renderer_progress_get_size(
...
static void set_color_according_to_perc(cairo_t *cr, double value) {
  static GdkRGBA red;
...
static void baobab_cell_renderer_progress_class_init(
    BaobabCellRendererProgressClass *klass) {
  ...
  g_object_class_install_property(
      object_class, PROP_PERC,
      g_param_spec_double("perc", "percentage", "precentage", -1, 100, 0,
                          G_PARAM_READWRITE));
}
