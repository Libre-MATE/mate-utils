...
#define GDICT_PREF_DIALOG(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GDICT_TYPE_PREF_DIALOG, GdictPrefDialog))
#define GDICT_IS_PREF_DIALOG(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GDICT_TYPE_PREF_DIALOG))
