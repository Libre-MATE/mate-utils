...
#define GDICT_SOURCE_LOADER(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GDICT_TYPE_SOURCE_LOADER, \
                              GdictSourceLoader))
#define GDICT_IS_SOURCE_LOADER(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GDICT_TYPE_SOURCE_LOADER))
#define GDICT_SOURCE_LOADER_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), GDICT_TYPE_SOURCE_LOADER, \
                           GdictSourceLoaderClass))
#define GDICT_IS_SOURCE_LOADER_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GDICT_TYPE_SOURCE_LOADER))
#define GDICT_SOURCE_LOADER_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GDICT_TYPE_SOURCE_LOADER, \
                             GdictSourceLoaderClass))
...
struct _GdictSourceLoaderClass {
  ...
  void (*source_loaded)(GdictSourceLoader *loader, GdictSource *source);
