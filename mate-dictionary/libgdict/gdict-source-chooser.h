...
#define GDICT_SOURCE_CHOOSER(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GDICT_TYPE_SOURCE_CHOOSER, \
                              GdictSourceChooser))
#define GDICT_IS_SOURCE_CHOOSER(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GDICT_TYPE_SOURCE_CHOOSER))
#define GDICT_SOURCE_CHOOSER_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), GDICT_TYPE_SOURCE_CHOOSER, \
                           GdictSourceChooserClass))
#define GDICT_IS_SOURCE_CHOOSER_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GDICT_TYPE_SOURCE_CHOOSER))
#define GDICT_SOURCE_CHOOSER_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GDICT_TYPE_SOURCE_CHOOSER, \
                             GdictSourceChooserClass))
