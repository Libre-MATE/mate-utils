...
#define GDICT_DEFBOX(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GDICT_TYPE_DEFBOX, GdictDefbox))
#define GDICT_IS_DEFBOX(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GDICT_TYPE_DEFBOX))
#define GDICT_DEFBOX_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), GDICT_TYPE_DEFBOX, GdictDefboxClass))
#define GDICT_IS_DEFBOX_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GDICT_TYPE_DEFBOX))
#define GDICT_DEFBOX_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GDICT_TYPE_DEFBOX, GdictDefboxClass))
...
struct _GdictDefboxClass {
  ...
  /* signals */
  void (*link_clicked)(GdictDefbox *defbox, const gchar *link);
...
gchar *gdict_defbox_get_text(GdictDefbox *defbox, gsize *length) G_GNUC_MALLOC;
