...
#define GDICT_DATABASE_CHOOSER(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GDICT_TYPE_DATABASE_CHOOSER, \
...
#define GDICT_DATABASE_CHOOSER_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), GDICT_TYPE_DATABASE_CHOOSER, \
...
#define GDICT_DATABASE_CHOOSER_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GDICT_TYPE_DATABASE_CHOOSER, \
                             GdictDatabaseChooserClass))
...
struct _GdictDatabaseChooserClass {
  ...
  /*< public >*/
  void (*database_activated)(GdictDatabaseChooser *chooser, const gchar *name,
...
gchar *gdict_database_chooser_get_current_database(
    GdictDatabaseChooser *chooser) G_GNUC_MALLOC;
